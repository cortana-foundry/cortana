...
name: stock-analysis
description: >
  Analyze stocks and cryptocurrencies using Yahoo Finance data. Portfolio management, watchlists, alerts, dividends, 8-dimension scoring, Hot Scanner, Rumor Scanner.
  USE WHEN: Stock prices, earnings, portfolio tracking, market analysis, crypto prices, trending stocks, M&A rumors, insider activity.
  DON'T USE: General business/world news (use news-summary), real-time trading execution, forex, commodities other than crypto.
version: 6.2.0
...
❌ "What's happening in the world?" → Use **news-summary** skill
❌ "Execute a trade / buy 10 shares" → Not supported (analysis only)
❌ "What's the EUR/USD exchange rate?" → Use web_search (forex not supported)
❌ "What's the price of gold futures?" → Use web_search (commodities limited)
❌ "Analyze my Schwab portfolio" → Use this skill with manual config (no Schwab API yet)
