...
- Current payload message references: `/Users/hd/openclaw/tools/briefing/run-daily-command-brief.sh`

To move to Phase 2 orchestration, this is the job whose payload should be updated later to run:
- `/Users/hd/openclaw/tools/morning-brief/orchestrate-brief.ts`
