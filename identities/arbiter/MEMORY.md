...
- Use the task board plus autonomy doctrine when logging trust/timing/correctness failures, especially missed/late reminders, stale or wrong alerts, duplicate/noisy chatter, failures to act, and wrong/incomplete actions.
