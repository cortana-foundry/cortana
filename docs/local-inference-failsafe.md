...
## Failsafe script
Path: `~/openclaw/tools/failsafe/local-inference.ts`
...
npx tsx ~/openclaw/tools/failsafe/local-inference.ts qa \
...
# Task queue mode
npx tsx ~/openclaw/tools/failsafe/local-inference.ts task_queue --limit 10

# Alert mode
npx tsx ~/openclaw/tools/failsafe/local-inference.ts alert \
